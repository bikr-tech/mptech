    ...
    <div className="glass-frost rounded-2xl p-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <input
          ...
          className="flex-1 min-w-[160px] bg-white/10 border border-white/15 rounded-full px-4 py-2 text-sm text-white placeholder-white/40 focus:outline-none focus:border-electric-400"
        />
      </div>
    </div>
  )
